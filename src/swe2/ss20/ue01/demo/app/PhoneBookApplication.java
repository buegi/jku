package swe2.ss20.ue01.demo.app;

import swe2.ss20.ue01.demo.phonebook.Entry;
import swe2.ss20.ue01.demo.phonebook.PhoneBook;
...
public class PhoneBookApplication {
    ...
    public static void main(String[] args) {
        ...
        Out.println("  i - insert: Einf�gen eines Eintrags ");
        Out.println("  f - first: ersten Eintrag anzeigen ");
        Out.println("  n - next: n�chsten Eintrag anzeigen ");
