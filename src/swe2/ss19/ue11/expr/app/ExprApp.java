package swe2.ss19.ue11.expr.app;

import static swe2.ss19.ue11.expr.Exprs.add;
import static swe2.ss19.ue11.expr.Exprs.lit;
import static swe2.ss19.ue11.expr.Exprs.minus;
import static swe2.ss19.ue11.expr.Exprs.mult;
import static swe2.ss19.ue11.expr.Exprs.recip;
import static swe2.ss19.ue11.expr.Exprs.var;
import static swe2.inout.In.readChar;
import static swe2.inout.Out.print;
import static swe2.inout.Out.println;
...
import swe2.ss19.ue11.expr.visitor.EvalVisitor;
import swe2.ss19.ue11.expr.visitor.InfixReprVisitor;
import swe2.ss19.ue11.expr.visitor.SimplyVisitor;
...
public class ExprApp {
	...
	/** Formatted prints using {@link swe2.inout.Out#println(String)}
	 * @param fmt the format string
	 * @param vals the values used 
	 */
	private static void printf(String fmt, Object...vals) {
		swe2.inout.Out.println(String.format(fmt, vals));
	}
