...
public class VaccinationStationClient {
    ...
    private static void insertExampleData(VaccinationStationModel<? extends Vaccine> model) {
    ...
    private static void addVaccine(VaccinationStationModel<? extends Vaccine> model, String name, String description, int quantity) {
        try {
            model.createVaccine(name);
            //final VaccineImpl vaccine = (VaccineImpl) model.getVaccine(name);
