...
// this is the original main method and will not work with remote additions from assignment
public class Main {
    ...
    private static void insertExampleData(VaccinationStationModelImpl model) throws RemoteException {
    ...
    private static void addVaccine(VaccinationStationModelImpl model, String name, String description, int quantity) throws RemoteException {
