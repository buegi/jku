...
class RadixSortTest2 {
	...
	@Test
	void testSort() {
		assertArrayEquals(b, listToArray(RadixSort2.sort(a)));
		assertArrayEquals(d, listToArray(RadixSort2.sort(c)));
	}
	...
	void testTestExceptions() {
		assertThrows(IllegalArgumentException.class, () -> RadixSort2.sort(null));
		assertThrows(IllegalArgumentException.class, () -> RadixSort2.sort(new Integer[] { 5, null }));
	}
}