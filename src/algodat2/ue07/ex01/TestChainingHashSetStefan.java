...
public class TestChainingHashSetStefan {
	...
	void testNotContains() {
		...
		for (int i = 0; i < 200; i++) {
			if (i < 100)
				...
				assertFalse(hs.contains(i), "Element was wrongfully found in ChainingHashSet");
		}
	}
	...
	void testToString() {
		...
		assertEquals("0 {-}, 1 {21}, 2 {-}, 3 {3, 23}, 4 {-}, 5 {5, 45}, 6 {-}, 7 {-}, 8 {-}, 9 {-}", hs.toString(),
