package ss20.ue01.demo.phonebook;
...
public final class PhoneBook {
    ...
    public Entry gotoFirstOfChar(char ch) {
        Node firstOfChar = index.getFirstOfChar(ch);
        if (firstOfChar == null) {
     ...
     * <p>
     * Remark: To goto the entry to delete use methods {@link gotoEntry}, {@link gotoFirstEntry}, {@link gotoNextEntry}, or {@link gotoFirstOfChar}.
     * </p>
     *
     * @return <code>true</code> if entry has been deleted, <code>false</code> otherwise
     */
